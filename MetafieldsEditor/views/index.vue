<template>
  <div class="main-content">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark m-0 p-0 text-sm font-weight-600 nobg">
                  ...
                  <li class="breadcrumb-item active text-light">Metafields Editor</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col-6">
                  <h3 class="mb-0">Click <span class="text-capitalize">{{ tabActive.replace('_', ' ').slice(0, -1) }}</span> to show the metafields</h3>
                </div>
                <div class="col-6">
                      ...
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">
                            <a href="" class="text-primary" @click.prevent="openModal(el)">
    ...
    <component is="inc-MetafieldsEditor-modal" :handle="tabActive" :id="modal.id" :title="modal.title" />
  ...
  methods: {
    ...
    openModal: function(el) {
      if (el.title) {
        ...
        this.modal.title = el.first_name + ' ' + el.last_name
      } else if (el.name) {
